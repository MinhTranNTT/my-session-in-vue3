<template>
  <!-- <section>
    ...
    <ul>
      <friend-contact
        name="Minh Tran"
        phone-number="012312312"
        email-address="tvhminh@gmail.com"
        is-favorite="1"
      />
      <friend-contact
        name="Brack Obana"
        phone-number="01239992"
        email-address="obana@gmail.com"
        is-favorite="0"
      />
    </ul>
  </section> -->
...
export default {
  ...
  methods: {
    toggleFavoriteStatus(friendId) {
      const identyFriend = this.friends.find(
